            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-8">
                    {categories.map((category) => (
                        <div
                            key={category.id}
                            className="bg-accent rounded-2xl p-6 text-center shadow-sm border border-gray-100 hover:shadow-xl hover:bg-white hover:-translate-y-2 hover:border-blue-100 transition-all duration-300 cursor-pointer group"
                        >
