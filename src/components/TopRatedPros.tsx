                            ...
                            <div className="p-6">
                                <div className="flex items-start gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-900 font-medium bg-accent inline-block px-2 py-1 rounded-md mt-1">
                                            {pro.service}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center text-yellow-400 gap-1">
                                        ...
                                        <span className="text-xs text-gray-900 font-medium ml-1">({pro.reviews} rəy)</span>
                                    </div>
                                    <div className="flex items-center text-xs text-gray-900 font-medium gap-1">
