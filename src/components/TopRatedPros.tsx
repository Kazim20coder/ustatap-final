                            ...
                            <div className="p-6">
                                <div className="flex items-start gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-foreground bg-accent inline-block px-2 py-1 rounded-md mt-1">
                                            {pro.service}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center text-yellow-400 gap-1">
                                        ...
                                        <span className="text-xs text-gray-400 ml-1">({pro.reviews} rəy)</span>
                                    </div>
                                ...
                                <button className="w-full bg-primary/10 text-primary hover:bg-primary hover:text-white py-3 rounded-xl font-bold transition-colors border border-transparent hover:border-primary">
                                    Zəng Et
                                </button>
                            </div>
                        </div>
